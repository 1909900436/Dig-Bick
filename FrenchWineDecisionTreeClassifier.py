...
list_text = [[13.52,3.17,2.72,23.5,97],[12.42,2.55,2.27,22,90],[13.76,1.53,2.7,19.5,132]]
print(list_text)#利用3个数据进行测试，即取3个数据作为模型的输入端
list_predict = model.predict(list_text)
dict_spe = {'Zinfandel':'仙粉黛','Syrah':'西拉','Sauvignon':'赤霞珠'}
relist = [dict_spe[x] if x in dict_spe else x for x in list_predict]
print(relist)#输出测试的结果，即输出模型预测的结果
